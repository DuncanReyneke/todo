var INIT_ITEMS = [
{
  name: 'Oil the hinges on my antique footlocker.',
  color: '',
  checked: false,
  edit: false,
  id: 1 },
...
{
  name: 'Walk the perimeter of my property and check for scoundrels.',
  color: 'pink',
  checked: false,
  edit: false,
  id: 2 },
...
{
  name: 'Retire after an early dinner and an evening of wealth.',
  color: 'purple',
  checked: false,
  edit: false,
  id: 3 }];
...
var Header = React.createClass({ displayName: "Header",
  ...
  getDefaultProps: function () {
    return {
      title: 'Quite Very Important Things To Remember 🐘' };
  ...
  render: function () {
    ...
    return (
      ...
      React.createElement("h1", { className: "clearfix" },
      this.props.title,
      React.createElement("a", {
        className: `float--right text--xs spacer--top--xs text--reg is--hidden ${showLinkClass}`,
        href: "#",
        onClick: this.handleClick }, "Clear Completed Items (",
      number, ")"))));
...
var AddItemForm = React.createClass({ displayName: "AddItemForm",
  ...
  render: function () {
    ...
    var radios = this.props.colorList.map(function (color, index) {
      ...
      return (
        React.createElement("input", { type: "radio", onChange: this.onColorChange, className: `colorSelector__inputRadio ${color.name} ${checkedClass}`, name: "selectedColor", "data-color": color.name, key: color.id }));
    ...
    return (
      ...
      React.createElement("div", { className: "colorSelector" },
      radios),
...
var EditItemForm = React.createClass({ displayName: "EditItemForm",
  propTypes: {
  ...
  render: function () {
    ...
    return (
      React.createElement("form", { className: `list__form ${editClass}`, onSubmit: this.onSubmit },
...
var Item = React.createClass({ displayName: "Item",
  ...
  render: function () {
    ...
    return (
      React.createElement("li", { className: `list__item ${colorClass} ${checkedClass}`, "data-id": this.props.id },
      React.createElement("div", { className: "list__checkbox" },
      React.createElement("input", { type: "checkbox", onChange: this.handleChange })),


      React.createElement("div", { className: "list__name" },
      React.createElement("p", { className: "list__text", onClick: this.onEditSwitch }, this.props.name),
...
var App = React.createClass({ displayName: "App",
  ...
  render: function () {
    return (
      ...
      React.createElement("ul", { className: "list", "data-area": true },
...
ReactDOM.render(
React.createElement(App, { initialItems: INIT_ITEMS, colors: COLORS }), document.getElementById('app'));